...
from VipMusic.utils.pastebin import VenomBin
...
async def stream(
    ...
    if streamtype == "playlist":
        ...
        if current_queue is not None and len(current_queue) >= 10:
            return await app.send_message(original_chat_id, "You can't add more than 10 songs to the queue.", parse_mode=ParseMode.HTML)
